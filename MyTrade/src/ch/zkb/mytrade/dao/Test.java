...
<<<<<<< HEAD
/*
	-----SQL STATEMENT F‹R OFFENE POSITIONEN ANZEIGEN------
=======
...
<<<<<<< HEAD
	...
	------Statement f¸r portfolio anzeigen---------
...
>>>>>>> refs/remotes/origin/master
	void top() throws Exception {
		...
		// erster Fehler: Connection zur√ºckgeben, welche nicht busy war:
		pooling.putConnection(c2);
		...
		pooling.getConnection();
		pooling.getConnection();
		pooling.getConnection(); // mehr als 5 sind nicht m√∂glich
